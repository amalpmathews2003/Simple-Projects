...
class AudioRecorder(object):
	...
	def __init__(self, start_btn, stop_btn, nickname):
		...
		# from client_gui import ClientClass
	...
	def stop_recording(self):
		...
		with concurrent.futures.ThreadPoolExecutor() as executer:
			t=executer.submit(self.save_recording_main)
			return t.result()
	...
	def save_recording_main(self):
		print('save_recording_main')
		file_name=f"{self.nickname} {str(time.ctime())[11:19].replace(':','_')}.wav"
		wavio.write(file_name,self.recording,self.freq,sampwidth=2)
